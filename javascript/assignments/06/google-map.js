var elMap = document.getElementById('map-container');                 // HTML element
...
if (navigator.geolocation) {                                // Is geo supported
  ...
  elMap.innerHTML = '<h2>Checking location</h2>';           // Say Checking Location...
} else {                                                    // Not supported
  elMap.textContent = msg;                                  // Add manual entry
}

function success(position) {                                // Got location
  msg = '<h3 class="long">Longitude:<br>';                               // Create message
  msg += position.coords.longitude + '</h3>';               // Add longitude
  msg += '<h3 class="lat">Latitude:<br>';                               // Create message
